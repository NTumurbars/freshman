            ...
            <div className="py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <Badge size="lg" color="blue">{major.code}</Badge>
                    </div>
                    <Link href={route('majors.edit', { school: school.id, major: major.id })}>
                        ...
                        <Card>
                            ...
                            <div className="space-y-4 mt-4">
                                <div>
                                    ...
                                    >
                                        <Text className="font-medium text-lg">{major.department.name}</Text>
                                    </Link>
                                </div>
                                
                                <div>
                                    <Text className="text-gray-500">Code</Text>
                                    <Text className="font-medium text-lg">{major.code}</Text>
                                </div>
                                
                                {major.name && (
                                    <div>
                                        <Text className="text-gray-500">Full Name</Text>
                                        <Text className="font-medium text-lg">{major.name}</Text>
                                    </div>
                                )}
                            ...
                            <div className="mt-4 space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <Text>Courses</Text>
                                            <Title>{major.courses?.length || 0}</Title>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <TabGroup>
                        <TabList className="mb-6">
                            <Tab icon={BookOpenIcon}>
                                Courses
                                {hasCourses && <Badge className="ml-2">{major.courses.length}</Badge>}
                            </Tab>
                                ...
                                <Card>
                                    ...
                                    {hasCourses ? (
                                        ...
                                        <div className="py-12 text-center">
                                            ...
                                            <Text className="mt-3 text-gray-500">No courses associated with this major yet</Text>
                                            <Link href={route('courses.create', { school: school.id })} className="mt-4 inline-block">
                            ...
                            <TabPanel>
                                <Card>
                                    ...
                                    <div className="py-12 text-center">
                                        ...
                                        <Text className="mt-3 text-gray-500">No students enrolled in this major yet</Text>
