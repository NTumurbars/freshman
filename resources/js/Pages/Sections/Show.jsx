        ...
        <div className="flex flex-col justify-between space-y-4 md:flex-row md:items-center md:space-y-0">
          <div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-600">{section.course?.code || ''}</span>
            </div>
          </div>
            ...
            <div className="px-6 py-4">
              <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    <ProfessorInfo professor={section.professor_profile} />
                  </dd>
                </div>
                <div>
                  <dt className="flex items-center text-sm font-medium text-gray-500">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    {section.students_count} / {section.effective_capacity || 'No limit'}
                    {section.capacity && (
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    {groupedSchedules.length > 0 && groupedSchedules[0].room
                      ? `${groupedSchedules[0].room.room_number} (${
                          groupedSchedules[0].room.floor?.building?.name || ''
                        })`
                      : 'Not assigned'}
                  </dd>
                </div>
                      ...
                      <div className="ml-3 w-full">
                        ...
                        <div className="mt-2 text-sm text-blue-700">
                          <p>
                            ...
                            {scheduleGroup.start_time.substring(0, 5)} -{' '}
                            {scheduleGroup.end_time.substring(0, 5)}
                          </p>
                          <p className="mt-1">
                          ...
                          {scheduleGroup.location_type &&
                            scheduleGroup.location_type !== 'in_person' && (
                              <>
                                <p className="mt-1">
