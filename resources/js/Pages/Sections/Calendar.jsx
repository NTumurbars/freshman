...
import { ChevronLeft, Filter, List, Plus, HelpCircle } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function SectionCalendar({ calendarEvents, resources, school }) {
  ...
  const buildings = [...new Set(resources.map(r => r.building))].filter(b => b !== 'N/A');
    ...
    if (calendarRef.current) {
      const calendar = new Calendar(calendarRef.current, {
        ...
        eventClick: function(info) {
          ...
          if (event) {
            setSelectedEvent({
              ...
              deliveryMethod: info.event.extendedProps.delivery_method,
              section_id: info.event.extendedProps.section_id,
              school_id: info.event.extendedProps.school_id || school.id,
            });
        ...
        eventDidMount: function(info) {
          ...
          } else if (info.event.extendedProps.delivery_method === 'hybrid') {
          ...
          info.el.addEventListener('mouseover', function() {
            ...
            tooltip.style.top = info.el.getBoundingClientRect().top + window.scrollY + 'px';
  ...
  useEffect(() => {
    if (calendarApi) {
      if (selectedBuilding === 'all') {
        ...
        calendarApi.setOption('resources', resources.filter(r => r.building === selectedBuilding));
      }
    }
      ...
      <div className="mb-6 space-y-4">
        <div className="flex flex-col justify-between space-y-4 md:flex-row md:items-center md:space-y-0">
          <div>
            ...
            <h1 className="text-2xl font-bold text-gray-800">Section Calendar</h1>
          </div>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            <div className="w-full md:w-auto">
              <label htmlFor="building-filter" className="mb-1 block text-sm font-medium text-gray-700">
                Building
              </label>
              <Select
                id="building-filter"
            ...
            <div className="w-full md:w-auto">
              <label htmlFor="view-filter" className="mb-1 block text-sm font-medium text-gray-700">
                View
              </label>
              <Select
                id="view-filter"
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="resourceTimeGridDay">Day</SelectItem>
                  <SelectItem value="resourceTimeGridWeek">Week</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
      ...
      <div className="rounded-lg border bg-white p-0 shadow">
        <div className="p-4">
          <div className="mb-2 flex items-center justify-between">
            <h2 className="text-lg font-medium">Room Availability</h2>
          ...
          <div className="mt-1 flex items-center text-xs text-gray-600">
            <div className="flex items-center mr-4">
              <div className="h-3 w-1 bg-green-500 mr-1"></div>
              <span>Online</span>
            </div>
            <div className="flex items-center">
              <div className="h-3 w-1 bg-purple-500 mr-1"></div>
              <span>Hybrid</span>
            </div>
          </div>
        </div>
      ...
      <Dialog open={showEventDetails} onOpenChange={setShowEventDetails}>
        <DialogContent>
          ...
          <div className="mt-4 space-y-3">
            <div>
              <div className="text-sm font-medium text-gray-500">Professor</div>
            ...
            <div>
              ...
              <div className="capitalize">{selectedEvent?.status || 'Active'}</div>
            </div>
            <div>
              <div className="text-sm font-medium text-gray-500">Delivery Method</div>
              <div className="capitalize">{selectedEvent?.deliveryMethod || 'In-person'}</div>
            </div>
            <div className="pt-4">
              <Link
                href={route('sections.show', [selectedEvent?.school_id || school.id, selectedEvent?.section_id])}
      ...
      <Dialog open={showHelp} onOpenChange={setShowHelp}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>How to use the calendar view for room scheduling</DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-medium">Delivery Method Indicators</h3>
              <div className="text-sm space-y-1">
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  <div className="h-4 w-1 bg-purple-500 mr-2"></div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm">
                Sections without assigned rooms appear in the "Unassigned" row at the top of the calendar.
                Click on any section to view details or to navigate to the section page.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm">
                The calendar shows the current schedule of all rooms, making it easier to identify available
                time slots for adding new section schedules. You can create a section without a schedule and
                add the schedule later when planning room allocations.
              </p>
            </div>
          </div>
        </DialogContent>
